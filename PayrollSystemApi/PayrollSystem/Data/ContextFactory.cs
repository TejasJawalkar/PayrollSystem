    ...
    public class ContextFactory : IDesignTimeDbContextFactory<DbsContext>
    {
        public DbsContext CreateDbContext(string[] args)
        {
            IConfigurationRoot configuration = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory())
                .AddJsonFile("appsettings.json").AddJsonFile($"appsettings.{Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT")}.json", optional: true).Build();
            ...
            optionsBuilder.UseSqlServer(connectionString, b => b.MigrationsAssembly("PayrollSystem.Data"));
